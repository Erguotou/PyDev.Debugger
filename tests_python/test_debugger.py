...
def test_case_7(case_setup):
    ...
    with case_setup.test_file('_debugger_case_local_variables.py') as writer:
        ...
        writer.wait_for_vars([
            [
                '<xml><var name="variable_for_test_1" type="int" qualifier="{0}" value="int%253A 10" scope="" />%0A</xml>'.format(builtin_qualifier),
        ...
        writer.wait_for_vars([
            [
                '<xml><var name="variable_for_test_1" type="int" qualifier="{0}" value="int%253A 10" scope="" />%0A<var name="variable_for_test_2" type="int" qualifier="{0}" value="int%253A 20" scope="" />%0A</xml>'.format(builtin_qualifier),
                '<var name="variable_for_test_1" type="int"  value="int%253A 10" />%0A<var name="variable_for_test_2" type="int"  value="int%253A 20" scope="" />%0A',  # jython
            ]
        ])
...
def test_case_16(case_setup):
    ...
    with case_setup.test_file('_debugger_case16.py') as writer:
        ...
        writer.wait_for_var((
            [
                '<var name="min" type="str" qualifier={0} value="str%253A ndarray too big%252C calculating min would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="min" type="str" qualifier={0} value="str%3A ndarray too big%252C calculating min would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="min" type="str" qualifier="{0}" value="str%253A ndarray too big%252C calculating min would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="min" type="str" qualifier="{0}" value="str%3A ndarray too big%252C calculating min would slow down debugging" scope="" />'.format(builtin_qualifier),
            ],
            [
                '<var name="max" type="str" qualifier={0} value="str%253A ndarray too big%252C calculating max would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="max" type="str" qualifier={0} value="str%3A ndarray too big%252C calculating max would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="max" type="str" qualifier="{0}" value="str%253A ndarray too big%252C calculating max would slow down debugging" scope="" />'.format(builtin_qualifier),
                '<var name="max" type="str" qualifier="{0}" value="str%3A ndarray too big%252C calculating max would slow down debugging" scope="" />'.format(builtin_qualifier),
            ],
            '<var name="shape" type="tuple"',
...
def test_case_18(case_setup):
    ...
    with case_setup.test_file('_debugger_case18.py') as writer:
        ...
        writer.wait_for_var('<xml><var name="" type="int" qualifier="{0}" value="int%253A 40" scope="" />%0A</xml>'.format(builtin_qualifier,))
        writer.write_run_thread(hit.thread_id)
...
def test_case_type_ext(case_setup):
    ...
    with case_setup.test_file('_debugger_case_type_ext.py', get_environ=get_environ) as writer:
        ...
        assert writer.wait_for_var([
            [
                r'<var name="my_rect" type="Rect" qualifier="__main__" value="Rectangle%255BLength%253A 5%252C Width%253A 10 %252C Area%253A 50%255D" isContainer="True" scope="" />',
        ...
        assert writer.wait_for_var(r'<var name="area" type="int" qualifier="{0}" value="int%253A 50" scope="" />'.format(builtin_qualifier))
        writer.write_run_thread(hit.thread_id)
        writer.finished_ok = True
